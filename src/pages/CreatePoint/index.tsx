...
// Estado = array => manualmente informar o tipo
...
const CreatePoint = () => {
  ...
  useEffect(() => {
    ...
    axios.get<IBGE_CITY[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`).then(response => {
